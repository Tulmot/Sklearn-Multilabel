...
class DisturbingNeigbors:
    ...
    def random_boolean(self,rnd_dimensions):
    ...
    #aleatoriamente
    def nearest_neighbor(self,m_reducida):
    ...
    def clasificate(self,X,Y,m_vecinos):
    ...
    def fit(self,X,Y):
        rnd_dimensions=random_boolean(self)
        rnd_neighbors=random_array(self)
        m_reducida=reduce_data(self,X)
        m_vecinos=nearest_neighbor(self,m_reducida)
        return clasificate(self,X,Y,m_vecinos)
    
    #Recibe la otra parte del conjunto de datos, a partir de la cual vamos
    #a poder predecir luego
    def predict(self,X1):
        m_reducida2=reduce_data(self,X1)
        m_vecinos2=nearest_neighbor(self,m_reducida2)
