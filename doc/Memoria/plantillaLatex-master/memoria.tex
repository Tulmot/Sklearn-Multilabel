...
% Datos de portada
\title{Clasificadores multi-label en Scikit Learn}
\author{\nombre}
...
\noindent Que el alumno D. \nombre, con DNI 71298897R, ha realizado el Trabajo final de Grado en Ingeniería Informática titulado "Clasificadores multi-label en Scikit Learn". 
